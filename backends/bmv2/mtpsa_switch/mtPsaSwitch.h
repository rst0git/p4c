#ifndef BACKENDS_BMV2_MTPSA_SWITCH_MTPSASWITCH_H_
#define BACKENDS_BMV2_MTPSA_SWITCH_MTPSASWITCH_H_
...
class MtPsaSwitchExpressionConverter : public ExpressionConverter {
 public:
    MtPsaSwitchExpressionConverter(P4::ReferenceMap* refMap, P4::TypeMap* typeMap,
...
class MtPsaProgramStructure : public ProgramStructure {
 ...
 public:
    MtPsaProgramStructure(P4::ReferenceMap* refMap, P4::TypeMap* typeMap)
...
class ConvertMtPsaToJson : public Inspector {
 public:
    ...
    void postorder(UNUSED const IR::P4Program* program) override {
        ...
        auto conv = new MtPsaSwitchExpressionConverter(refMap, typeMap, structure, scalarsName);
        auto ctxt = new ConversionContext(refMap, typeMap, toplevel, structure, conv, json);
        structure->create(ctxt);
    }
};

class MtPsaSwitchBackend : public Backend {
    BMV2Options &options;

 public:
    void convert(const IR::ToplevelBlock* tlb) override;
    MtPsaSwitchBackend(BMV2Options& options, P4::ReferenceMap* refMap, P4::TypeMap* typeMap,
...
#endif  /* BACKENDS_BMV2_MTPSA_SWITCH_MTPSASWITCH_H_ */
